...
*                      the "startup_MM32F031C8T.s" file.
*
...
*    Then SystemInit() function is called, in "system_MM32F031C8T.s" file, to
...
*    the product used), refer to "HSE_VALUE" define in "MM32F031C8T.h" file. 
...
void SetSysClockTo24_HSI()
{
    ...
    RCC->CR &=~(0x1f<<26);	
    RCC->CR|=(2 - 1) << 26;   //设置PLL值 2~16
    
    FLASH->ACR=FLASH_ACR_PRFTBE;	  //FLASH 0个延时周期
